...
tracker_name = "hai_agora_track"
product_desc = "HAI Agora"
...
def fetch():
    ...
    headers = {
        ...
        "referer": (
            ...
            "0a29b2f4-390e-453e-961a-d477493b5b81/tasks"
        ),
        "cookie": os.getenv(
            "hai_agora_track_cookie",
            os.getenv("hai_ivy_track_cookie", os.getenv("hai_evaluator_cookie", "")),
        ),
    }
